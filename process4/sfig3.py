...
unit1 = ' ($\mathregular{mm^{-1}}$ per 3 or 5 years)'
...
if __name__ == '__main__':
    ...
    Sensi_3Y_trend_slope[2:4, :, :] = read_data(data_path('study2/results/result_july/ELAI_SM12_ERA5-land_monthly_1982_2017_0d50_5Yblock_SensiTrend.npy'))[0,:,:,:]
    Sensi_3Y_trend_p[2:4, :, :] = read_data(data_path('study2/results/result_july/ELAI_SM12_ERA5-land_monthly_1982_2017_0d50_5Yblock_SensiTrend.npy'))[1,:,:,:]
    ...
    plt.text(0.015, 36.15, '(A) 3-Y block')
    plt.text(0.015, 27.75, '(B) 5-Y block')
    plt.text(0.015, 17.3, '(C) 3-Y block')
    plt.text(0.015, 8.95, '(D) 5-Y block')

    plt.savefig(data_path('study2/results/result_april/figure2/figs3.jpg'), bbox_inches='tight')
